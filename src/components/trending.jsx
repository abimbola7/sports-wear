...
export default function Trending() {
  return (
    <section className={`mt-12 px-4 bg-customBlack ${oswald.className} text-white`}>
      <div className="grid max-w-7xl mx-auto grid-cols-3 gap-x-7">
        ...
        <div className="">
          <Image
            ...
            height={200}
          />
          <p className='my-6 text-3xl font-semibold'>MEN</p>
        </div>
        <div className="">
          <p className='my-6 text-3xl font-semibold'>WOMEN</p>
          <Image
